...
var taskCompleted=function(){
    ...
    label.className = 'task-item__label task-item__label_completed';
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    const label = listItem.querySelector('.task-item__label_completed')
    label.className = 'task-item__label';
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".task-btn_edit");
    var deleteButton=taskListItem.querySelector(".task-btn_delete");
